...
public class ProductPropertyDao {
	...
	public boolean add(ProductPropertyBean productPropertyBean) {
		...
		productPropertyBean.getSort() + "','" + createDate1.format(new Date()) + "')";
		Connection conn = DBUtil.getConn();
		Statement state = null;
		boolean f = false;
		int a = 0;
	...
	public boolean update (ProductPropertyBean productPropertyBean) {
		String sql = "update product_type_property set name='" + productPropertyBean.getName() + "',sort='" + productPropertyBean.getSort()
		+ "',product_type_id='" + productPropertyBean.getProductTypeId() + "' where id='" + productPropertyBean.getId() + "'";
		Connection conn = DBUtil.getConn();
		Statement state = null;
		boolean f = false;
		int a = 0;
