...
<html>
			...
			$.post("../property/productPropertyServlet",{
				...
				if (data != null && data.length > 0) {
					...
					for (var property in data) {
						...
						content += "<td><a href='productPropertyServlet?method=delete&id="+data[property].id+"' onclick='return del()'>删除</a></td></tr>";
					}
	...
	<body>
		<div class="container">
			...
			<table class="table table-striped" id="property0"></table>
			<div class="form-group col-md-12">
				<c:if test="${param.status.equals('1')}">
					<div class="alert alert-success" role="alert">修改属性成功</div>
				</c:if>
				<c:if test="${param.status.equals('2')}">
					<div class="alert alert-success" role="alert">删除属性成功</div>
				</c:if>
			</div>
		</div>
	</body>
