			...
			<div class="menu">
				<div class="menuParent">
					...
					<div class="menuList">
						...
						<div><a target="mainAction" href="../admin/adminServlet?method=list">查看管理员信息</a> </div>
					</div>
				</div>
				<div class="menuParent">
					<div class="ListTitlePanel">
				...
				<div class="menuParent">
					...
					<div class="menuList">
						<div> <a target="mainAction" href="../admin/userServlet?method=list">用户信息查询</a></div>
						<div> <a target="mainAction" href="../admin/frontUser/blockUser.jsp">冻结账号</a></div>
						<div> <a target="mainAction" href="../admin/frontUser/userOrder.jsp">查询用户订单</a></div>
					</div>
				</div>
				<div class="menuParent">
					<div class="ListTitlePanel">
					...
					<div class="menuList">
						<div> <a target="mainAction" href="../admin/userOrderServlet?method=list">查询订单</a></div>
						<div> <a target="mainAction" href="../admin/frontUser/del.jsp">删除订单</a></div>
					</div>
				</div>
			</div>
		</div>
