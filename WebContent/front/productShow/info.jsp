...
<html>
		...
		<script type="text/javascript">
			$().ready(function(){
				$("#addItem").click(function(){
					...
					$.get("../shopping/shoppingServlet?method=addItem", {num:num, productId:productId}, function(data) {
						if (data == 0)
							document.getElementById("status").innerHTML="添加购物车成功";
						else if (data == 1)
							document.getElementById("status").innerHTML="商品数不能为0";
						else
							document.getElementById("status").innerHTML="添加商品大于库存";
					}, "text");
				});
	...
	<body data-spy = "scroll">
		...
		<div class="info col-md-8 col-md-offset-2">
			<img class="col-sm-4 img-thumbnail" alt="商品图片未加载" src="${productBean.pic}">
			<dl class="col-sm-8 dl-horizontal">
				<dt>商品名称:</dt>
				<dd>${productBean.name}</dd>
				<dt class="originalPrice">原价:</dt>
				<dd><del>￥${productBean.originalPrice}</del></dd>
				...
				<dt></dt>
				<dd>
					<form action="../shopping/shoppingServlet?method=addItem&id=${productBean.id}" method="post">
						<div class="input-group col-xs-5">
							<span class="input-group-btn">
								<button type="button" class="btn" data-value="decrease" data-target="#num" data-toggle="spinner">
									<span class="glyphicon glyphicon-minus"></span>
								</button>
							</span>
							<input type="text" data-ride="spinner" name="items" id="num" class="form-control input-number" value="1"/>
							<span class="input-group-btn">
								<button type="button" class="btn" data-value="increase" data-target="#num" data-toggle="spinner">
		...
		<div hidden id="navbar1" class="navbar1 col-md-8 col-md-offset=2 navbar-fixed-top" data-target=".navbar-example" data-offset="0">
			<ul class="nav nav-tabs">
				<li role="presentation" class="active">
					<a href="#property">商品属性</a>
				</li>
				<li role="presentation">
					<a href="#intro">商品简介</a>
				</li>
				<li role="presentation">
					<a href="#comment">商品评价</a>
				</li>
			</ul>
		</div>
		<div class="info col-md-8 col-md-offset-2">
