...
<html>
	...
	<body onload="createCode()">
		<div class="row-fluid" style="margin-top: 200px;">
			...
			<div class="col-md-4">
				<form role="form" class="form-horizontal" action="${pageContext.request.contextPath}/front/user/userServlet?method=login"
					...
					<c:if test="${param.status.equals('2')}">
						<div class="alert alert-danger" role="alert">账户已冻结，请联系管理员</div>
					</c:if>
				</form>
			</div>
			<div class="col-md-4"></div>
