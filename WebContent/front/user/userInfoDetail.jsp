...
<body>
	...
	<div class=" col-md-2 col-md-offset-1">
		<img class="img-circle" alt="用户头像未加载 " src="${userBean.pic}"
			width="150px" height="150px">
		<form enctype="multipart/form-data"
			action="${pageContext.request.contextPath}/front/user/userServlet?method=updatePic&id=${userBean.id}"
			method="post">
			<input type="file"
	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form enctype="multipart/form-data"
					action="${pageContext.request.contextPath}/front/user/userServlet?method=updateInfo&id=${userBean.id}"
