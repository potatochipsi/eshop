	...
	<div class="navbar navbar-defult" role="navigation">
		...
		<!-- Brand and toggle get grouped for better mobile display -->
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		    	<form target="_top" class="navbar-form navbar-left" action="${pageContext.request.contextPath}/front/productShow/productShowServlet?method=search" method="post" role="search" >
		    	...
		    	<ul class="nav navbar-nav navbar-right">
		    		<li><a target="_parent" href="${pageContext.request.contextPath}/front/user/userServlet?method=logout">退出登录</a></li>
		    	</ul>
		    	<ul class="nav navbar-nav navbar-right">
		    		<li><a target="mainAction" href="${pageContext.request.contextPath}/front/shopping/shoppingServlet?method=myOrder">订单中心</a></li>
		    	</ul>
		    	<ul class="nav navbar-nav navbar-right">
		    		<li><a target="mainAction" href="${pageContext.request.contextPath}/front/user/userServlet?method=detail">用户：${userBean.username}</a></li>
		    	</ul>
		    	<ul class="nav navbar-nav navbar-right">
